...
public class TwitterSourceConnectorTest {
    ...
    public void setup() {
        ...
        this.defaultSettings
            .put(TwitterSourceConnectorConfig.TWITTER_OAUTH_ACCESS_TOKEN_CONF, "xxxxxx");
        this.defaultSettings
            .put(TwitterSourceConnectorConfig.TWITTER_OAUTH_SECRET_KEY_CONF, "xxxxxx");
        this.defaultSettings
            .put(TwitterSourceConnectorConfig.TWITTER_OAUTH_CONSUMER_KEY_CONF, "xxxxxx");
        this.defaultSettings
            .put(TwitterSourceConnectorConfig.TWITTER_OAUTH_ACCESS_TOKEN_SECRET_CONF, "xxxxxx");
    ...
    public Stream<DynamicTest> taskConfigs() {
        ...
        return testCases.entrySet().stream()
            .map(e -> dynamicTest(e.getKey().toString(), () -> {
                this.defaultSettings
                    .put(TwitterSourceConnectorConfig.FILTER_KEYWORDS_CONF, "one,two,three");

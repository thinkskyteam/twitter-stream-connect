...
public class StatusConverter {
    ...
    public static final Schema USER_SCHEMA = SchemaBuilder.struct()
        .name("com.thinksky.kafka.twitter.stream.connect.User")
        .doc(
        ...
        .field("Name",
            SchemaBuilder.string().doc("Returns the name of the user").optional().build())
        .field("ScreenName",
            SchemaBuilder.string().doc("Returns the screen name of the user").optional().build())
        .field("Location",
            SchemaBuilder.string().doc("Returns the location of the user").optional().build())
        .field("Description",
            SchemaBuilder.string().doc("Returns the description of the user").optional().build())
        .field("ContributorsEnabled",
            SchemaBuilder.bool().doc("Tests if the user is enabling contributors").optional()
                .build())
        .field("ProfileImageURL",
            SchemaBuilder.string().doc("Returns the profile image url of the user").optional()
                .build())
        ...
        .field("DefaultProfileImage",
            SchemaBuilder.bool().doc("Tests if the user has not uploaded their own avatar")
                .optional()
                .build())
        .field("URL", SchemaBuilder.string().doc("Returns the url of the user").optional().build())
        .field("Protected",
            SchemaBuilder.bool().doc("Test if the user status is protected").optional().build())
        .field("FollowersCount",
            SchemaBuilder.int32().doc("Returns the number of followers").optional().build())
        ...
        .field("DefaultProfile",
            SchemaBuilder.bool().doc("Tests if the user has not altered the theme or background")
                .optional().build())
        .field("ShowAllInlineMedia", SchemaBuilder.bool().optional().build())
        .field("FriendsCount", SchemaBuilder.int32()
            .doc("Returns the number of users the user follows (AKA \"followings\")").optional()
            .build())
        ...
        .field("Lang",
            SchemaBuilder.string().doc("Returns the preferred language of the user").optional()
                .build())
        ...
        .field("ListedCount", SchemaBuilder.int32().doc(
            "Returns the number of public lists the user is listed on, or -1 if the count is unavailable.")
            .optional().build())
        .field("FollowRequestSent", SchemaBuilder.bool().doc(
            "Returns true if the authenticating user has requested to follow this user, otherwise false.")
            .optional().build())
        .field("WithheldInCountries", SchemaBuilder.array(Schema.STRING_SCHEMA)
            .doc("Returns the list of country codes where the user is withheld").build())
        .build();

    public static final Schema SCHEMA_MEDIA_ENTITY_VARIANT = SchemaBuilder.struct()
        .name("com.thinksky.kafka.twitter.stream.connect.ExtendedMediaEntity.Variant")
        .doc("")
    ...
    public static final Schema SCHEMA_MEDIA_ENTITY_SIZE = SchemaBuilder.struct()
        .name("com.thinksky.kafka.twitter.stream.connect.MediaEntity.Size")
        .doc("")
    ...
    public static final Schema SCHEMA_EXTENDED_MEDIA_ENTITY = SchemaBuilder.struct()
        .name("com.thinksky.kafka.twitter.stream.connect.ExtendedMediaEntity")
        .doc("")
        ...
        .field("VideoVariants",
            SchemaBuilder.array(SCHEMA_MEDIA_ENTITY_VARIANT).optional().doc("").build())
        ...
        .field("Type", SchemaBuilder.string().optional()
            .doc("Returns the media type photo, video, animated_gif.").build())
        ...
        .field("Sizes", SchemaBuilder.map(Schema.INT32_SCHEMA, SCHEMA_MEDIA_ENTITY_SIZE)
            .doc("Returns size variations of the media.").build())
        .field("MediaURLHttps",
            SchemaBuilder.string().optional().doc("Returns the media secure URL.").build())
        .field("URL",
            SchemaBuilder.string().optional().doc("Returns the URL mentioned in the tweet.")
                .build())
        .field("Text",
            SchemaBuilder.string().optional().doc("Returns the URL mentioned in the tweet.")
                .build())
        .field("ExpandedURL", SchemaBuilder.string().optional()
            .doc("Returns the expanded URL if mentioned URL is shorten.").build())
        .field("Start", SchemaBuilder.int32().optional()
            .doc("Returns the index of the start character of the URL mentioned in the tweet.")
            .build())
        .field("End", SchemaBuilder.int32().optional()
            .doc("Returns the index of the end character of the URL mentioned in the tweet.")
            .build())
        .field("DisplayURL", SchemaBuilder.string().optional()
            .doc("Returns the display URL if mentioned URL is shorten.").build())
        .build();

    public static final Schema SCHEMA_HASHTAG_ENTITY = SchemaBuilder.struct()
        .name("com.thinksky.kafka.twitter.stream.connect.HashtagEntity")
        .doc("")
        .field("Text",
            SchemaBuilder.string().optional().doc("Returns the text of the hashtag without #.")
                .build())
        .field("Start", SchemaBuilder.int32().optional()
            .doc("Returns the index of the start character of the hashtag.").build())
        .field("End", SchemaBuilder.int32().optional()
            .doc("Returns the index of the end character of the hashtag.").build())
        .build();

    public static final Schema SCHEMA_MEDIA_ENTITY = SchemaBuilder.struct()
        .name("com.thinksky.kafka.twitter.stream.connect.MediaEntity")
        .doc("")
        .field("Id", SchemaBuilder.int64().optional().doc("Returns the id of the media.").build())
        .field("Type", SchemaBuilder.string().optional()
            .doc("Returns the media type photo, video, animated_gif.").build())
        ...
        .field("VideoAspectRatioHeight", SchemaBuilder.int32().optional().doc("").build())
        .field("VideoDurationMillis", SchemaBuilder.int64().optional().doc("").build())
        .field("VideoVariants", SchemaBuilder.array(SCHEMA_MEDIA_ENTITY_VARIANT).optional()
            .doc("Returns size variations of the media.").build())
        .field("ExtAltText", SchemaBuilder.string().optional().doc("").build())
        .field("URL",
            SchemaBuilder.string().optional().doc("Returns the URL mentioned in the tweet.")
    ...
    public static final Schema SCHEMA_SYMBOL_ENTITY = SchemaBuilder.struct()
        .name("com.thinksky.kafka.twitter.stream.connect.SymbolEntity")
        .doc("")
        .field("Start", SchemaBuilder.int32().optional()
            .doc("Returns the index of the start character of the symbol.").build())
        .field("End", SchemaBuilder.int32().optional()
            .doc("Returns the index of the end character of the symbol.").build())
        .field("Text",
            SchemaBuilder.string().optional().doc("Returns the text of the entity").build())
        .build();

    public static final Schema SCHEMA_URL_ENTITY = SchemaBuilder.struct()
        .name("com.thinksky.kafka.twitter.stream.connect.URLEntity")
        .doc("")
        .field("URL",
            SchemaBuilder.string().optional().doc("Returns the URL mentioned in the tweet.")
                .build())
    ...
    public static final Schema SCHEMA_USER_MENTION_ENTITY = SchemaBuilder.struct()
        .name("com.thinksky.kafka.twitter.stream.connect.UserMentionEntity")
        .doc("")
        .field("Name",
            SchemaBuilder.string().optional().doc("Returns the name mentioned in the status.")
                .build())
        .field("Id",
            SchemaBuilder.int64().optional().doc("Returns the user id mentioned in the status.")
                .build())
        .field("Text",
        ...
        .field("ScreenName",
            SchemaBuilder.string().optional()
                ...
                .build())
        .field("Start", SchemaBuilder.int32().optional()
            .doc("Returns the index of the start character of the user mention.").build())
        .field("End", SchemaBuilder.int32().optional()
            .doc("Returns the index of the end character of the user mention.").build())
        .build();

    static {
        PLACE_SCHEMA = SchemaBuilder.struct()
            .name("com.thinksky.kafka.twitter.stream.connect.Place")
            .optional()
    ...
    static {
        GEO_LOCATION_SCHEMA = SchemaBuilder.struct()
            .name("com.thinksky.kafka.twitter.stream.connect.GeoLocation")
            .optional()
            .doc("Returns The location that this tweet refers to if available.")
            .field("Latitude",
                SchemaBuilder.float64().doc("returns the latitude of the geo location").build())
            .field("Longitude",
                SchemaBuilder.float64().doc("returns the longitude of the geo location").build())
            .build();
    }

    static {
        STATUS_SCHEMA_KEY = SchemaBuilder.struct()
            .name("com.thinksky.kafka.twitter.stream.connect.StatusKey")
    ...
    static {
        STATUS_SCHEMA = SchemaBuilder.struct()
            .name("com.thinksky.kafka.twitter.stream.connect.Status")
            .doc("Twitter status message.")
            .field("CreatedAt", Timestamp.builder().doc("Return the created_at").optional().build())
            .field("Id",
                SchemaBuilder.int64().doc("Returns the id of the status").optional().build())
            .field("Text",
                SchemaBuilder.string().doc("Returns the text of the status").optional().build())
            .field("Source", SchemaBuilder.string().doc("Returns the source").optional().build())
            .field("Truncated",
                SchemaBuilder.bool().doc("Test if the status is truncated").optional().build())
            .field("InReplyToStatusId",
                SchemaBuilder.int64().doc("Returns the in_reply_tostatus_id").optional().build())
            .field("InReplyToUserId",
                SchemaBuilder.int64().doc("Returns the in_reply_user_id").optional().build())
            .field("InReplyToScreenName",
                SchemaBuilder.string().doc("Returns the in_reply_to_screen_name").optional()
                    .build())
            .field("GeoLocation", GEO_LOCATION_SCHEMA)
            .field("Place", PLACE_SCHEMA)
            .field("Favorited",
                SchemaBuilder.bool().doc("Test if the status is favorited").optional().build())
            .field("Retweeted",
                SchemaBuilder.bool().doc("Test if the status is retweeted").optional().build())
            .field("FavoriteCount", SchemaBuilder.int32().doc(
            ...
            .field("Contributors", SchemaBuilder.array(Schema.INT64_SCHEMA).doc(
                "Returns an array of contributors, or null if no contributor is associated with this status.")
                .build())
            .field("RetweetCount", SchemaBuilder.int32().doc(
            ...
            .field("CurrentUserRetweetId", SchemaBuilder.int64().doc(
            ...
            .field("Lang",
                SchemaBuilder.string().doc("Returns the lang of the status text if available.")
                    .optional().build())
            .field("WithheldInCountries", SchemaBuilder.array(Schema.STRING_SCHEMA)
                .doc("Returns the list of country codes where the tweet is withheld").build())
            .field("HashtagEntities", SchemaBuilder.array(SCHEMA_HASHTAG_ENTITY)
                .doc("Returns an array if hashtag mentioned in the tweet.").optional().build())
            .field("UserMentionEntities", SchemaBuilder.array(SCHEMA_USER_MENTION_ENTITY)
                .doc("Returns an array of user mentions in the tweet.").optional().build())
            .field("MediaEntities", SchemaBuilder.array(SCHEMA_MEDIA_ENTITY)
                .doc("Returns an array of MediaEntities if medias are available in the tweet.")
                .optional().build())
            .field("SymbolEntities", SchemaBuilder.array(SCHEMA_SYMBOL_ENTITY)
                .doc("Returns an array of SymbolEntities if medias are available in the tweet.")
                .optional().build())
            .field("URLEntities", SchemaBuilder.array(SCHEMA_URL_ENTITY)
                .doc("Returns an array if URLEntity mentioned in the tweet.").optional().build())
    ...
    static {
        SCHEMA_STATUS_DELETION_NOTICE = SchemaBuilder.struct()
            .name("com.thinksky.kafka.twitter.stream.connect.StatusDeletionNotice")
    ...
    static {
        SCHEMA_STATUS_DELETION_NOTICE_KEY = SchemaBuilder.struct()
            .name("com.thinksky.kafka.twitter.stream.connect.StatusDeletionNoticeKey")
    ...
    public static void convert(User user, Struct struct) {
        ...
        if (null != user.getWithheldInCountries()) {
            Collections.addAll(withheldInCountries, user.getWithheldInCountries());
        }
    ...
    public static void convert(Status status, Struct struct) {
        ...
        if (null != status.getWithheldInCountries()) {
            withheldInCountries.addAll(Arrays.asList(status.getWithheldInCountries()));
        }
        struct.put("WithheldInCountries", withheldInCountries);

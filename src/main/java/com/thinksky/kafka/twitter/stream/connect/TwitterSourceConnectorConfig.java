...
public class TwitterSourceConnectorConfig extends AbstractConfig {
    ...
    public static final String TWITTER_OAUTH_ACCESS_TOKEN_SECRET_CONF =
    ...
    public static ConfigDef conf() {
        return new ConfigDef()
            ...
            .define(TWITTER_OAUTH_CONSUMER_KEY_CONF, Type.PASSWORD, Importance.HIGH,
                TWITTER_OAUTH_CONSUMER_KEY_DOC)
            .define(TWITTER_OAUTH_SECRET_KEY_CONF, Type.PASSWORD, Importance.HIGH,
                TWITTER_OAUTH_SECRET_KEY_DOC)
            .define(TWITTER_OAUTH_ACCESS_TOKEN_CONF, Type.PASSWORD, Importance.HIGH,
                TWITTER_OAUTH_ACCESS_TOKEN_DOC)
            .define(TWITTER_OAUTH_ACCESS_TOKEN_SECRET_CONF, Type.PASSWORD, Importance.HIGH,
                TWITTER_OAUTH_ACCESS_TOKEN_SECRET_DOC)
